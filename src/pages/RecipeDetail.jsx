...
export default function RecipeDetail() {
  ...
  useEffect(() => {
    if (mealDetail?.strMeal) {
      document.title = `${mealDetail.strMeal} | MyRecipes`;
    }
  }, [mealDetail]);
  ...
  return (
    <>
      <SEO
        title={`${mealDetail.strMeal} | MyRecipes`}
        description={`Learn how to make ${mealDetail.strMeal} with this easy recipe. Includes ingredients and step-by-step instructions.`}
